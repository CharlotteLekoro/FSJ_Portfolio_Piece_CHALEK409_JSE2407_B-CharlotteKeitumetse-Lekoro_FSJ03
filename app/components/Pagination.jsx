    ...
    <div className="flex justify-between items-center mt-8">
      {prevPage && (
        <Link href={buildUrl(prevPage)}>
          <button className="px-4 py-2 bg-green-400 text-white rounded-lg hover:bg-blue-700 transition-colors duration-300">
            Previous Page
          </button>
        </Link>
      )}
      ...
      <Link href={buildUrl(nextPage)}>
        <button className="px-4 py-2 bg-green-400 text-white rounded-lg hover:bg-gray-600 transition-colors duration-300">
          Next Page
        </button>
      </Link>
    </div>
